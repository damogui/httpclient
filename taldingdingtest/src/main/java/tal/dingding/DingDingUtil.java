...
public class DingDingUtil {
    private static String CORPID = "dinge4adeae79ec3c6aa35c2f4657eb6378f"; // 企业Id
    private static String CORPSECRET = "D20traVPqE2hWPp3ciNGoxwSTcl23MiZQVCKfBjhFCW_QDGD4HtUTXHEl-8gKtgn"; // 企业应用的凭证密钥
    public static Long AGENTID = 180309097L; // 自动分配微应用的ID
    ...
    private static String getToken(String corpid, String corpsecret){
        String result = HttpClientUtls.sendGet("https://oapi.dingtalk.com/gettoken?corpid="+ corpid + "&corpsecret=" + corpsecret);
